...
public class asmPassOne {
	public static void main(String args[]) throws NullPointerException, FileNotFoundException {
		...
		try {
				...
				for (int k = 0; k < tokens.length; k++) {
					...
					switch (tokens[k]) {
						...
						case "end":
							 ...
							 * else
							 * {
							 * pooltab[pooltab_cnt]=new
							 * Pooltable(pooltab[pooltab_cnt-1].first+pooltab[pooltab_cnt-1].total_literals,
			...
			pooltab[pooltab_cnt] = new Pooltable(pooltab[pooltab_cnt - 1].first + pooltab[pooltab_cnt - 1].total_literals,
